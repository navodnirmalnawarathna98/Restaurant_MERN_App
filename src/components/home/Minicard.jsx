  ...
  return (
    <div className='bg-[#1a1a1a] py-5 px-5 rounded-lg w-[50%]'>
        <div className="flex items-start justify-between">
            <h1 className='text-[#f5f5f5] text-lg front-semibold tracking-wide'>{title}</h1>
        ...
        <div> 
            ...
            <h1 className="text-[#f5f5f5] text-lg mt-2 "><span className="text-[#02ca3a]">{footerNum}%</span>then yesterday</h1>
        </div>
    </div>
  )
}
